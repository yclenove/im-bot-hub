...
const DEFAULT_QUERY = 'useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true';
export function buildMysqlJdbcUrl(host, port, database) {
    const h = host.trim();
...
export function parseMysqlJdbcUrl(url) {
